{{ Form::open(array('route'=>'admin.prodotto.store', 'id'=>'insertProdotto', 'files'=>'true')) }}
    ...
    <div class="input-group single">
        ...
        {{ Form::textarea('descrizione','', ['max-length' => config('strings.prodotto.descrizione'), 'required', 'placeholder' => 'Inserisci il testo qui...']) }}
    ...
    <div class="input-group single">
        ...
        {{ Form::textarea('specifiche','', ['max-length' => config('strings.prodotto.specifiche'), 'required', 'placeholder' => 'Inserisci il testo qui...']) }}
    ...
    <div class="input-group single">
        ...
        {{Form::textarea('guida_installazione','', ['max-length' => config('strings.prodotto.guida_installazione'), 'placeholder' => 'Inserisci il testo qui...']) }}
    ...
    <div class="input-group single">
        ...
        {{ Form::textarea('note_uso','', ['max-length' => config('strings.prodotto.note_uso'), 'placeholder' => 'Inserisci il testo qui...']) }}
    ...
    {{ Form::submit ('Inserisci prodotto', ['class' => 'button btn-form']) }}
