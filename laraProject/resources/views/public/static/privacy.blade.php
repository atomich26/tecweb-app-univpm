@extends('layouts.public', ['title' => 'Informativa sulla privacy'])
...
@section('content')
    ...
    <ul>
        ...
        <li>
            <p><strong>Per l'esecuzione di un contratto:</strong> lo sviluppo, la conformità e l'esecuzione del contratto di acquisto per i prodotti, gli articoli o i servizi acquistati o di qualsiasi altro contratto con noi attraverso il Servizio.</p>
        </li>
        <li>
