...
@section('selected-items-actions')
    @if(count($centriAssistenza) > 0 && User::where('role', 'tecnico')->exists())
        <div class="px-1 thead-widget bulkActionInput">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button class="button bulkActionBtn" id="assign-btn" onclick="assignUtentiCentro(event)" data-url="{{ route('admin.utenti.assign') }}" value="Assegna un utente al centro assistenza"><i class="bi bi-plus-circle"></i></button>
                </div>
            </div>
        </div>
    @endif
