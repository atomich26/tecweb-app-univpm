...
class CentriAssistenzaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('centri_assistenza')->insert([
            ...
            'ragione_sociale' => 'C&C',
            'telefono' => '0880101010',
            'email' => 'supporto@c&c.it',
            'sito_web' => 'www.cecspa.it',
